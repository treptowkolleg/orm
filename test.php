...
class Teacher
{
    ...
    #[Attribute\Column(length: 50, nullable: true)]
    private string $firstname;

    #[Attribute\Column(length: 50)]
...
class EmployeeList
{
    ...
    #[Attribute\Column(type: Attribute\Type::ManyToOne)]
    #[Attribute\ManyToOne(Teacher::class, "id")]
    private int $teacher;
    private Teacher $teacherObject;

    #[Attribute\Column(type: Attribute\Type::Date)]
    private string $startDate;

    #[Attribute\Column(type: Attribute\Type::Date, nullable: true)]
